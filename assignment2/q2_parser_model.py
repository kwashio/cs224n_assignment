...
class ParserModel(Model):
    ...
    def run_epoch(self, sess, parser, train_examples, dev_set):
        ...
        # 修正, eval_batch_sizeにlen(dev_set)を代入、バグ？
        dev_UAS, _ = parser.parse(dev_set, eval_batch_size=len(dev_set))
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as session:
            ...
            if not debug:
                ...
                UAS, dependencies = parser.parse(test_set, eval_batch_size=len(test_set))
